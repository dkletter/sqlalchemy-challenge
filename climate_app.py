    ...
    return (
		...
		f'<table border="1">'
			...
			f'<tr>'
				...
				f'<td>Daily precipitation rates</td>'
				f'<td><a href="http://127.0.0.1:5000/api/v1.0/precipitation">Try</a></td>'
			f'</tr>'
			f'<tr>'
				f'<td>/api/v1.0/stations</td>'
				f'<td>Available weather stations</td>'
				f'<td><a href="http://127.0.0.1:5000/api/v1.0/stations">Try</a></td>'
			f'</tr>'
			f'<tr>'
				f'<td>/api/v1.0/tobs</td>'
				f'<td>Temperature observations (TOBS) for past 12 months</td>'
				f'<td><a href="http://127.0.0.1:5000/api/v1.0/tobs">Try</a></td>'
			f'</tr>'
			f'<tr>'
				f'<td colspan="4">For the following routes, use date format YYYY-MM-DD</td>'
			f'</tr>'
			f'<tr>'
				f'<td>/api/v1.0/start?start_date=&ltstart_datet&gt</td>'
				f'<td>TOBS stats for dates greater than &ltstart_date&gt</td>'
				f'<td><a href="http://127.0.0.1:5000/api/v1.0/start?start_date=2013-01-01">Try</a></td>'
			f'</tr>'
			f'<tr>'
				f'<td>/api/v1.0/between?start_date=&ltstart_datet&gt&end_date=&ltend_datet&gt</td>'
				f'<td>TOBS stats for dates between &ltstart_date&gt and &ltend_date&gt</td>'
				f'<td><a href="http://127.0.0.1:5000/api/v1.0/between?start_date=2015-01-01&end_date=2016-12-31">Try</a></td>'
			f'</tr>'
		f'</table>'
    )
